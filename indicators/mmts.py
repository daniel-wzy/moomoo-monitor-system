...
def compute(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Double confirmation: 2+ ZIG levels agreeing OR trough + any ZIG
    out["MMTS_BUY_DOUBLE"] = (buy_count >= 2) | (buy1 & buy2)
    ...
    for name in ACTIVE_ALERTS:
        ...
        if last.get(sig["column"], False):
            ...
            context = {
                ...
                # Compatibility fields for format_alert
                "hma_state": "NEUTRAL",
                "trend": "UP" if sig["direction"] == "BUY" else "DOWN",
            }
